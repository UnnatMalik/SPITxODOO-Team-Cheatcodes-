...
function NewReceiptPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NewReceiptPage.useEffect": ()=>{
            const fetchData = {
                "NewReceiptPage.useEffect.fetchData": async ()=>{
            ...
            }["NewReceiptPage.useEffect.fetchData"];
            fetchData();
        }
    }["NewReceiptPage.useEffect"], []);
    const addLine = ()=>{
    ...
    const handleSubmit = async ()=>{
        ...
        if (!res.ok) {
            alert("Failed to create receipt header");
            return;
        }
        ...
        // 3. Validate (Optional: Auto-validate for hackathon speed)
        const validateRes = await fetch(`http://127.0.0.1:8000/api/receipts/${receipt.id}/validate/`, {
            method: "POST",
            headers: {
                Authorization: `Token ${token}`
            }
        ...
        if (validateRes.ok) {
            alert("Receipt Created & Validated! Stock updated.");
            router.push("/products"); // Go back to see the new stock!
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(NewReceiptPage, "dEpPB+RIZ2GwNJ2dl+OXwiv6u0c=", false, function() {
    return [
...
_c = NewReceiptPage;
var _c;
__turbopack_context__.k.register(_c, "NewReceiptPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_0572415d._.js.map